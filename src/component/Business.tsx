...
export default function Business(){
    return (
            <section className="  lg:py-md:py-16 py-12 flex md:flex-row max-md:gap-8  flex-col text-white">
                ...
                <button className="primaryBtn">Explore Fiveer Business</button>
                </div>
                <img className="md:w-[54%] max-md:hidden object-scale-down" src={Img.business} />
                <img className=" md:hidden object-scale-down" src={Img.business2} />
            </section>
    )
}