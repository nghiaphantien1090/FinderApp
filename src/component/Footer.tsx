...
import { FooterContents } from "../assets/util/Data"

export default function Footer(){
    const ref = useRef(null)
    const[show,setShow] = useState(false)
    const handleShow1=(e:React.MouseEvent<HTMLHeadingElement, MouseEvent>)=>{
        setShow(prev=>!prev)
    }
    const handleShow=()=>{
     let isShow=true
        setShow(prev=>{isShow=!prev ;return isShow})
        return isShow
    }
    return(
    <section>
            <div className=" border-b-[1px] flex lg:justify-between sm:flex-wrap max-sm:flex-col sm:justify-between sm:gap-24 ">
                {
                    FooterContents.map((Conts) => {
                        return (
                            <Contents Conts={Conts} />
                        )
                    })
                }
            </div>
            <div className="py-6 flex flex-wrap max-md:flex-col  justify-between max-md:justify-center">
                <div className=" py-3 flex flex-wrap md:justify-start justify-center gap-6">
                    ...
                    <div className="my-auto text-[14px] text-[#b5b6ba]">
                        <p className="mt-3">
                            <span>© </span>
...
function Contents({ Conts }: { Conts: { Content: string, List: string[] } }) {
    ...
    return (
        <div>
            <div className=" cursor-pointer max-sm:flex max-sm:justify-between text-[#404145] font-semibold pb-5" onClick={handleShow}>
                <h5>
                    {Conts.Content}
                </h5>
                <div className="sm:hidden flex justify-end" >
                    <svg fill="#74767e" style={{transition:'.2s', transform: `${show ? 'rotate(-90deg)' : 'rotate(90deg) '}`, }} width="8" height="16" viewBox="0 0 8 16" xmlns="http://www.w3.org/2000/svg"><path d="M0.772126 1.19065L0.153407 1.80934C0.00696973 1.95578 0.00696973 2.19322 0.153407 2.33969L5.80025 8L0.153407 13.6603C0.00696973 13.8067 0.00696973 14.0442 0.153407 14.1907L0.772126 14.8094C0.918563 14.9558 1.156 14.9558 1.30247 14.8094L7.84666 8.26519C7.99309 8.11875 7.99309 7.88131 7.84666 7.73484L1.30247 1.19065C1.156 1.04419 0.918563 1.04419 0.772126 1.19065Z"></path></svg>
                </div>
            </div>
            {
                <ul className={`overflow-hidden `} style={{height:` ${show?'100%':'0'}` }}>
                    {
                        Conts.List.map(item => {
                            return (
